...
export default function CriarScreen() {
  ...
  const submit = useCallback(async () => {
    if (!mainImage) {
      Alert.alert("Faltou a imagem", "Selecione uma imagem.");
      return;
    }
    if (!word) {
  ...
  }, [mainImage, selectedTheme, word, apiFetch, router, offerBoost]);
        ...
        >
          {mainImage ? (
            ...
            <View style={styles.pickerEmpty}>
              ...
              <Text style={styles.pickerEmptyTitle}>ADICIONAR IMAGEM</Text>
